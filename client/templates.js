(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><nav class="navbar navbar-default"><div class="container-fluid"><div class="navbar-header"><a href="/" class="navbar-brand">Our App</a></div><ul class="nav navbar-nav"><li><a href="/users">Users</a></li></ul><p data-hook="user-name" class="navbar-text navbar-right"></p></div></nav><div class="container"><main data-hook="page-container"></main></div></body>';
    };
    ...
    templatizer["pages"]["users"] = function tmpl_pages_users() {
        return '<section class="page"><h2>Users</h2><ul data-hook="user-list"></ul></section>';
    };
